<template>
  <main role="main" class="site-main">
    ...
    <p>ФИО: <strong>asfasfasfasf</strong></p>
    <p>Адрес доставки: <strong>sfaasfasf</strong></p>
    <p>Почтовый индекс: <strong>142142</strong></p>
    <p>Телефон: <strong></strong></p>

    <div class="offset_left_wr">
      <div class="offset_left_in order_form2">
        <form
          action="/?mode=order&amp;step=order"
          method="post"
          class="shop2-order-form"
        >
          ...
          <div class="form-item form-item-submit">
            <router-link :to="'/confirm'" class="shop2-btn shop2-btn--large">
...
export default {
  name: "OrderDop",
  components: { SitePath, ButtonBack },
};
</script>
